...
<body>
    <div class="container">
        <h1 class="text-center">Novo Player</h1>
            <div class="col-md-6">
            <?= form_open('usuario/gravarP');  ?>
                ...
                <div class="form_group">
                <label for="titulos">Títulos</label><span class="erro"><?php echo form_error('titulos') ? : '' ?> </span>
                    <input type="text" name="titulos" id="titulos" value="<?= set_value('titulos') ? : (isset($titulos) ? $titulos : '') ?>" class="form-control" />
                </div>
                <div class="form_group">
